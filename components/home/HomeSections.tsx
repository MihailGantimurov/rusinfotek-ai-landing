...
const roles = [
  {
    ...
    result:
      'Единый цифровой контур, прозрачная ответственность и основа для последовательного масштабирования.',
    directions: [
      'Все направления',
      'Сквозная аналитика',
  ...
  },
  {
    ...
    result:
      'Автоматизированная обработка лидов, подготовка материалов и контроль клиентских коммуникаций.',
  ...
  },
  {
    ...
    result:
      'Связанный поток заявок, перевозок, производства, документов и исключений.',
...
const articles = [
  {
    category: 'Кейс',
    title:
      'Как 15+ модулей объединили продажи, CRM, 1С и сервис в единый AI-контур',
  },
  {
    category: 'Практика',
  ...
  },
  {
    category: 'Логистика',
    title:
      'AI в логистике: путь заявки от входящего сообщения до контроля рентабельности',
  },
];
  ...
  return (
    <section className="relative z-10 -mt-16 bg-[#eef0ee] px-5 pb-14 pt-20 sm:px-8 lg:px-12 xl:px-16">
      <div className="mx-auto grid max-w-[1440px] border-y border-[#10233b]/10 md:grid-cols-3">
        {[
          [
            'Продукты по 4 направлениям',
            'Продажи · Логистика · Производство · Документооборот',
            'Каталог решений',
          ],
          [
            'Быстрое внедрение',
            '2 недели от аудита до пользования',
            'От постановки задачи до запуска',
          ],
          [
            'Единый контур',
          ...
          <div
            className={`py-7 md:px-7 ${index > 0 ? 'border-t border-[#10233b]/10 md:border-l md:border-t-0' : ''}`}
            key={value}
          >
            <p className="text-[clamp(1.45rem,2vw,2rem)] font-[560] tracking-[-0.035em] text-[#10233b]">
              {value}
            </p>
            <p className="mt-1 text-[14px] font-medium text-[#10233b]/72">
              {label}
            </p>
            <p className="mt-3 text-[11px] font-semibold tracking-[0.08em] text-[#596fc0]">
              {note.toUpperCase()}
            </p>
          </div>
        ))}
...
export function Approach() {
  ...
  return (
    <section
      id="approach"
      className="relative overflow-hidden bg-[#edf0ef] px-5 py-24 sm:px-8 sm:py-28 lg:px-12 lg:py-36 xl:px-16"
    >
      <div
        aria-hidden="true"
        className="absolute -right-48 top-24 size-[36rem] rounded-full bg-[#8197d4]/14 blur-[110px]"
      />
      <div className="relative mx-auto max-w-[1440px]">
        <Reveal className="grid gap-7 lg:grid-cols-[.85fr_1.15fr] lg:items-end">
          ...
          <p className="max-w-2xl text-[18px] leading-[1.7] text-[#10233b]/60 lg:justify-self-end">
            Начинаем с живого процесса и проектируем цифровой слой так, чтобы он
            работал в существующей инфраструктуре, ролях и правилах компании.
          </p>
        </Reveal>
        ...
        <div className="relative mt-16 lg:mt-24">
          <div
            aria-hidden="true"
            className="absolute left-5 top-5 hidden h-[calc(100%-2.5rem)] w-px bg-linear-to-b from-[#667dd0]/70 via-[#667dd0]/25 to-transparent lg:block"
          />
          <div className="grid gap-4 lg:gap-0">
            {approachSteps.map((step, index) => (
              ...
              >
                ...
                <h3 className="text-[clamp(1.55rem,2.2vw,2.2rem)] font-[540] leading-tight tracking-[-0.035em] text-[#10233b]">
                  {step.title}
                </h3>
                <p className="max-w-2xl text-[16px] leading-[1.75] text-[#10233b]/58 lg:text-[17px]">
                  {step.text}
                </p>
              </motion.article>
            ))}
        ...
        <Reveal className="mt-14 overflow-hidden rounded-[28px] bg-[#0b203a] p-7 text-white sm:p-10 lg:mt-20 lg:p-14">
          <div className="grid gap-10 lg:grid-cols-[.72fr_1.28fr]">
            <div>
              ...
              <h3 className="mt-7 max-w-lg text-[clamp(1.8rem,3vw,3.2rem)] font-[540] leading-[1.08] tracking-[-0.04em]">
                Интегрируемся с вашей инфраструктурой
              </h3>
              <p className="mt-5 max-w-md text-[16px] leading-relaxed text-white/60">
                Сохраняем привычные рабочие системы и связываем их общей логикой
                данных и действий.
              </p>
            </div>
            <div className="flex flex-wrap content-start gap-2.5 lg:pt-2">
              {integrations.map((integration) => (
                <span
                  className="rounded-[11px] border border-white/12 bg-white/[0.055] px-4 py-3 text-[14px] text-white/74"
                  key={integration}
                >
                  {integration}
                </span>
...
export function CasesSection() {
  return (
    <section
      id="cases"
      className="relative bg-[#f7f7f5] px-5 py-24 sm:px-8 sm:py-28 lg:px-12 lg:py-36 xl:px-16"
    >
          ...
          {cases.map((item, index) => (
            <Reveal delay={index * 0.06} key={item.name}>
              <article className="group flex h-full flex-col overflow-hidden rounded-[24px] border border-[#10233b]/9 bg-white shadow-[0_24px_70px_rgba(20,35,55,.06)]">
                <MediaFrame
                  asset={{ kind: 'image', src: item.image, alt: item.imageAlt }}
                  className="aspect-[1.25/1] min-h-72 transition-transform duration-700 group-hover:scale-[1.015]"
                ...
                <div className="flex grow flex-col p-6 sm:p-7">
                  <div className="flex items-start justify-between gap-4">
                    <div>
                      ...
                      <h3 className="mt-3 text-[1.55rem] font-[560] leading-tight tracking-[-0.035em] text-[#10233b]">
                        {item.name}
                      </h3>
                    </div>
                    <span className="font-mono text-[11px] text-[#10233b]/35">
                      0{index + 1}
                    </span>
                  </div>
                  <p className="mt-2 min-h-10 text-[13px] leading-relaxed text-[#10233b]/48">
                    {item.attribution}
                  </p>
                  <dl className="mt-6 space-y-4 border-t border-[#10233b]/9 pt-5">
                    <div>
                      <dt className="text-[12px] font-semibold text-[#10233b]/40">
                        Задача
                      </dt>
                      <dd className="mt-1 text-[14px] leading-relaxed text-[#10233b]/70">
                        {item.task}
                      </dd>
                    </div>
                    <div>
                  ...
                  <ul className="mt-5 space-y-2.5">
                    {item.results.map((result) => (
                      <li
                        className="flex gap-2.5 text-[14px] leading-relaxed text-[#10233b]/72"
                        key={result}
                      >
...
export function SecuritySection() {
  const items = [
    [
      ShieldCheck,
      'Требования к данным',
      'Учитываем до начала внедрения и фиксируем в архитектуре решения.',
    ],
    [
      ServerCog,
      'Контур клиента',
      'Возможна работа внутри инфраструктуры компании без вынесения ключевых данных наружу.',
    ],
    [
      Building2,
      'Проектирование с ИБ',
      'Требования информационной безопасности становятся частью проекта, а не финальной проверкой.',
    ],
  ] as const;
    ...
    <section className="bg-[#f7f7f5] px-5 pb-24 sm:px-8 sm:pb-28 lg:px-12 lg:pb-36 xl:px-16">
      <Reveal className="mx-auto grid max-w-[1440px] gap-12 rounded-[28px] border border-[#10233b]/9 bg-[#eef0ee] p-7 sm:p-10 lg:grid-cols-[.82fr_1.18fr] lg:p-14">
        <div>
          ...
          <h2 className="mt-5 max-w-xl text-[clamp(2rem,3.5vw,3.8rem)] font-[540] leading-[1.08] tracking-[-0.045em] text-[#10233b]">
            AI с учётом корпоративных требований
          </h2>
          <p className="mt-6 max-w-lg text-[16px] leading-[1.75] text-[#10233b]/60">
        ...
        <div className="divide-y divide-[#10233b]/10 border-y border-[#10233b]/10">
          {items.map(([Icon, title, text]) => (
            ...
            >
              ...
              <div>
                <h3 className="text-[17px] font-semibold text-[#10233b]">
                  {title}
                </h3>
                <p className="mt-2 text-[15px] leading-relaxed text-[#10233b]/58">
                  {text}
                </p>
              </div>
            </article>
    ...
    <section className="bg-[#0a1d34] px-5 py-24 text-white sm:px-8 sm:py-28 lg:px-12 lg:py-36 xl:px-16">
      <div className="mx-auto max-w-[1440px]">
        <Reveal>
          ...
          <h2 className="mt-5 max-w-4xl text-[clamp(2.25rem,4.4vw,4.8rem)] font-[540] leading-[1.03] tracking-[-0.05em]">
            Один проект — разные управленческие задачи
          </h2>
        </Reveal>
        <Tabs
          className="mt-12 gap-9 lg:mt-16 lg:grid lg:grid-cols-[.7fr_1.3fr]"
          defaultValue={roles[0].value}
          orientation="vertical"
        >
          <TabsList
            className="grid h-auto w-full gap-0 rounded-none bg-transparent p-0"
            variant="line"
          >
            {roles.map((role, index) => (
              <TabsTrigger
                ...
                value={role.value}
              >
                <span className="mr-4 font-mono text-[10px] text-[#91a7ff]">
                  0{index + 1}
                </span>
                {role.label}
              </TabsTrigger>
          ...
          <div className="min-h-[390px] rounded-[26px] border border-white/12 bg-[radial-gradient(circle_at_92%_8%,rgba(101,112,209,.26),transparent_36%),rgba(255,255,255,.045)] p-7 sm:p-10 lg:p-12">
            {roles.map((role) => (
              <TabsContent
                ...
                value={role.value}
              >
                <p className="text-[13px] font-semibold tracking-[0.08em] text-[#aab9f4]">
                  ЗАДАЧА
                </p>
                <h3 className="mt-4 max-w-3xl text-[clamp(1.7rem,3vw,3.25rem)] font-[520] leading-[1.12] tracking-[-0.04em]">
                  {role.task}
                </h3>
                <p className="mt-8 max-w-2xl border-t border-white/12 pt-7 text-[17px] leading-[1.7] text-white/64">
                  {role.result}
                </p>
                <div className="mt-8 flex flex-wrap gap-2">
                  {role.directions.map((direction) => (
                    <span
                      className="rounded-[10px] border border-white/13 px-3.5 py-2 text-[13px] text-white/62"
                      key={direction}
                    >
                      {direction}
                    </span>
        ...
        <Reveal className="grid gap-7 lg:grid-cols-[.9fr_1.1fr] lg:items-end">
          <div>
            ...
            <h2 className="section-title mt-5">
              Компетенции на стороне бизнеса и технологий
            </h2>
          </div>
    ...
    <section className="bg-[#eef0ee] px-5 pb-24 sm:px-8 sm:pb-28 lg:px-12 lg:pb-36 xl:px-16">
      <div className="mx-auto max-w-[1440px] border-t border-[#10233b]/11 pt-16">
        <Reveal className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
          <div>
            <p className="section-label">БЛОГ И НОВОСТИ</p>
            <h2 className="section-title mt-5">
            ...
            <Reveal delay={index * 0.05} key={article.title}>
              ...
              >
                <div className="flex items-center justify-between">
                  <span className="text-[12px] font-semibold tracking-[0.08em] text-[#6075c7]">
                    {article.category}
                  </span>
                  <span className="font-mono text-[10px] text-[#10233b]/34">
                    0{index + 1}
                  </span>
                </div>
                <div>
                  <h3 className="text-[clamp(1.4rem,2vw,1.9rem)] font-[540] leading-[1.2] tracking-[-0.035em] text-[#10233b]">
                    {article.title}
                  </h3>
                  <span className="mt-6 inline-flex items-center gap-2 text-[14px] font-semibold text-[#17385f]">
                    Читать анонс{' '}
...
export function FinalCta() {
  return (
    <section className="relative overflow-hidden bg-[#0a1d34] px-5 py-20 text-white sm:px-8 sm:py-24 lg:px-12 lg:py-28 xl:px-16">
      <div
        aria-hidden="true"
        className="absolute -right-32 top-0 size-[34rem] rounded-full bg-[#5268bb]/24 blur-[105px]"
      />
      <Reveal className="relative mx-auto grid max-w-[1440px] gap-10 lg:grid-cols-[1.15fr_.85fr] lg:items-end">
        <div>
          ...
          <h2 className="mt-5 max-w-4xl text-[clamp(2.35rem,4.5vw,5rem)] font-[540] leading-[1.02] tracking-[-0.052em]">
            Обсудить задачу с РусИнфоТек
          </h2>
        </div>
        <div className="lg:justify-self-end">
          <p className="max-w-xl text-[17px] leading-[1.7] text-white/62">
            Свяжитесь с менеджером. Мы уточним задачу, организуем встречу с
            профильным специалистом и подготовим коммерческое предложение.
          </p>
